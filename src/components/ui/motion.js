...
/** ζ≈1.08 — settles just short of a bounce. */
export const SPRING_SOFT = { type: 'spring', stiffness: 137, damping: 30, mass: 1.4 }

/** ζ≈0.62 — the only genuinely bouncy spring in the reference. Use sparingly. */
export const SPRING_BOUNCE = { type: 'spring', stiffness: 137, damping: 30, mass: 4.3 }

/** ζ≈1.11 — slow and heavy, long tail. */
export const SPRING_SLOW = { type: 'spring', stiffness: 52, damping: 16, mass: 1 }
...
/** Retained for the few places that still use a timed tween. */
